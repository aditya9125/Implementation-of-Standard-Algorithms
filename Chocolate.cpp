...
{
	public :
		bool operator()(pair< int,int > A, pair< int,int > B)		///for sorting through comparator ,can be modified
		{
			return (A.F> B.F);
		}
};
